# Code adapted from https://github.com/nveldt/CategoricalEdgeClustering

using JSON
using JLD
using CSV
using DataFrames
cooking = JSON.parsefile("C://Users//gavin//OneDrive//Desktop//MFC-Julia//data//Cooking//train.json")
